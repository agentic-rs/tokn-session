...
- `codex/` contains an isolated cross-platform experiment for the Codex App
  private IPC router. It is not connected to Terminal Pet yet and requires
  callers to pass an explicit Unix-socket or Windows-pipe endpoint.
