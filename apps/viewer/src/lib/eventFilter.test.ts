...
describe("bookkeeping filter classification", () => {
  it.each(["session_started", "provider_changed", "session_settings_applied", "lifecycle", "metadata"])(
  ...
  it.each(["usage", "error", "unknown", "message", "reasoning", "tool_call", "agent_activity", "compaction", "goal_updated", "trajectory", "future_provider_event"])(
  ...
  it("preserves errors reported through lifecycle or metadata records", () => {
